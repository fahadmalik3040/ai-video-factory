// Pure browser-safe procedural GLSL generator with ZERO Node.js / fs dependencies

export function generateProceduralGLSL(topic: string, seed: string = "42"): string {
  let hash = 0;
